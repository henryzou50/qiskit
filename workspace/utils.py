...
def create_and_save_ghz_circuits(num_qubits_list, save_dir="circuits/ghz"):
...
def create_and_save_qft_circuits(num_qubits_list, save_dir="circuits/qft"):
    # Create the save directory if it doesn't exist
    os.makedirs(save_dir, exist_ok=True)
...
def create_and_save_qv_circuits(num_qubits_list, depth_list, seed=42, save_dir="circuits/qv"):
    # Create the save directory if it doesn't exist
    os.makedirs(save_dir, exist_ok=True)
